    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          <Link to="/blog/" className="bg-white border border-slate-200 rounded-xl p-5 hover:border-[#6351d5]/40 transition-colors">
          ...
          <Link to="/articulos/" className="bg-white border border-slate-200 rounded-xl p-5 hover:border-[#6351d5]/40 transition-colors">
          ...
          <Link to="/casos-de-exito/" className="bg-white border border-slate-200 rounded-xl p-5 hover:border-[#6351d5]/40 transition-colors">
          ...
          <Link to="/lead-magnets/" className="bg-white border border-slate-200 rounded-xl p-5 hover:border-[#6351d5]/40 transition-colors">
          ...
          <Link to="/feedback/" className="bg-white border border-slate-200 rounded-xl p-5 hover:border-[#6351d5]/40 transition-colors">
