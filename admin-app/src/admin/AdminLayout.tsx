...
export default function AdminLayout() {
  ...
  const navigation: { name: string; href: string; icon: any; badge?: number }[] = [
    ...
    { name: 'Casos de Éxito', href: '/casos-de-exito/', icon: Trophy },
    { name: 'Lead Magnets', href: '/lead-magnets/', icon: Download },
    { name: 'Instagram', href: '/instagram/', icon: Camera },
    { name: 'IG Bot', href: '/instagram-bot/', icon: Bot },
    { name: 'LinkedIn', href: '/linkedin/', icon: LinkedinIcon },
    { name: 'LinkedIn Bot', href: '/linkedin-bot/', icon: Bot, badge: liBotBadge },
    { name: 'Visibilidad', href: '/visibilidad/', icon: Search },
