 ...
 * notion-sync.ts
 * ─────────────────────────────────────────────────────────────────
 * Vercel API route (was Netlify Scheduled Function).
 * Reads posts with Status=Ready from the Content Calendar in Notion,
 * generates a GEO blog with Claude, publishes to Firebase and marks
 * the post as Published in Notion.
 *
