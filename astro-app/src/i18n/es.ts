export const es = {
  ...
  methodology: {
    ...
    stages: [
      ...
      { step: 'Etapa 2', title: 'ESCALANDO', tag: '10K → 500K Users', desc: 'Implementamos el **Trust Engine**: generamos confianza posicionando la marca en **medios de autoridad e influencers**. Un motor de crecimiento que prioriza clientes reales.', icon: 'trending-up', guaranteeTitle: 'OBJETIVO & GARANTÍA', guarantees: [ 'Tracción orgánica y reconocimiento de marca vía **Referral**.', 'Conversión de **Clientes que pagan** y alto LTV.' ] },
