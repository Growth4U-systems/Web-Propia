...
export default async (req: Request, _context: Context) => {
  ...
  try {
    ...
    const audit = {
      ...
      metaTitle: { text: metaTitle, length: metaTitleLength },
      metaDescription: { text: metaDescription, length: metaDescriptionLength },
      ...
      sitemap: { found: sitemapFound, url: sitemapUrl || null },
      https: isHttps,
